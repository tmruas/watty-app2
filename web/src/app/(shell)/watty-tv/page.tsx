...
export default function WattyTvPage() {
  return (
      ...
      <div className="grid gap-6 md:grid-cols-2">
        {CARDS.map((c) => (
          ...
          >
            ...
            <p className="bg-white/95 px-3 py-2 text-sm font-bold text-watty-purple">
              {c.title}
            </p>
            <p className="px-3 pb-3 text-xs text-slate-500">
              Coloca os ficheiros .mp4 em <code className="rounded bg-slate-100 px-1">web/public/media/</code> se o vídeo não carregar.
            </p>
          </article>
        ))}
      </div>
